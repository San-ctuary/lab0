...
func HomeHandler(w http.ResponseWriter, r *http.Request) {
	...
	sqlFilePath := filepath.Join(filepath.Dir(filepath.Dir(currentFilePath)), "mbta.sqlite")
	err := db.Open(sqlFilePath)
	if err != nil {
	...
	base64String := base64.StdEncoding.EncodeToString(chart)
	...
	data := struct {
		...
		Image: base64String, // TODO: base64 string
		Chart: selectedChart,
	}
